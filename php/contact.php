    ...
    <div class="container-fluid navbar-container">
        ...
        <div class="collapse navbar-collapse" id="navbar">
            <ul class="nav navbar-nav">
                ...
                <li class="navItem"><a class="navLink" target="blank" href="https://www.facebook.com/pg/rochestervegancommunitycenter/events/">EVENTS</a></li>
...
<iframe src="https://www.google.com/maps/embed/v1/place?q=14%20Edmonds%20Street%20Rochester%2C%20NY%2014604&key=AIzaSyA5uubCZlsxkbnQy4o_igOKvtMh_pgwV94" allowfullscreen></iframe>
</div>
...
<p class="form">Are you interested in teaching a class? Maybe you'd like to rent the space for a event or have an idea for a workshop. Let us know and we'll work with you to make it happen. We can't wait to hear from you.</p>
...
<noscript>
	...
	<label for="email">E-mail: *</label> 
		<input type="text" name="email" id="email" placeholder="Your email address" value="<?php get_data("email"); ?>" /><br />
	
	<label for="comments">Comments: *</label>
		<textarea name="comments" id="comments" rows="5" cols="20" placeholder="Your message"><?php get_data("comments"); ?></textarea><br />
</p>

	<p class="submit"><input type="submit" name="submit" id="submit" value="Submit" <?php if (isset($disable) && $disable === true) echo ' disabled="disabled"'; ?> />
</p>
</form>
  ...
  <div class="row" id="about">
 		...
 		<p class="full">It is the brainchild of local animal rights activist, yogi, and business owner, Mary Barletta. Mary made the choice not to eat animals as a child and has made it her life’s mission to help them in every way she can. The center was created out of a necessity. Globally, veganism is a growing movement that shows no signs of stopping and the center aims to be a place where the community can spread it’s wings.</p>

 		<p class="full">We seek to inspire support and grow veganism by educating people about the "why" and "how" of adopting a vegan lifestyle, expanding and connecting our circle of individuals, united in their compassion for all living beings, and hosting exciting events that will enrich not only the vegan community but the entire community of Rochester.</p>
  </div>
 
  <div class="col-xs-12 col-sm-6 col-md-6">
     <img class="piclinkhalf"src="mary_rvcc.png" alt="Mary Barletta with a friend at Skylands" title="Mary Barletta with a friend at Skylands">
     </div>
...
<div id="footer" class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-xs-4 col-sm-4 col-md-4" id="planterbox">  
                    ...
                    <img id="grass" src="img/grass.png" alt="grass graphic" title="grass graphic">
        ...
        <div class="row">
            ...
            <div class="col-xs-6 col-sm-4 col-md-4" id="footershop">
                ...
                <a href="https://www.etsy.com/shop/veganarmy269?ref=l2-shopheader-name"><img id="va_button" src="img/va_button.png" alt="Vegan Army Logo" title="Vegan Army Logo"></a>
            </div>
        </div>
